...
const Popup = ({ setOpenPopup, setUpdateTable }: PropsType) => {
  ...
  return (
    <div className="fixed top-0 left-0 w-full h-screen bg-[#00000070] grid place-items-center">
      <div className="bg-white w-[500px] py-8 rounded-lg text-center relative">
        <IoIosCloseCircleOutline
          className="absolute txt-2xl right-0 top-0 m-4 cursor-pointer hover:text-red-600"
        ...
        <form className="mt-6 w-fit space-y-4 mx-auto " onSubmit={handleSubmit}>
          ...
          <div className="flex flex-col items-center">
            <button className="bg-accent block text-white px-8 py-2 rounded-lg horizontal-center self-center">
              Salvar Alterações
            </button>
          </div>
        </form>
