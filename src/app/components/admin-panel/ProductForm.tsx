...
const ProductForm = () => {
  ...
  return (
    <form className="flex flex-col gap-4 w-[500px]" onSubmit={handleSubmit}>
      ...
      />
      <div>
        <label className="block ml-1">Nome</label>
        <input
          className="bg-gray-300 w-full px-4 py-2 border outline-greenMenus"
          type="text"
          value={payload.name}
      ...
      <div>
        <label className="block ml-1">Preço</label>
        <input
          className="bg-gray-300 w-full px-4 py-2 border outline-greenMenus"
          type="text"
          value={payload.price}
      ...
      <div className="flex flex-col items-center">
        <button className=" bg-greenMenus text-white px-8 py-2 rounded">
          Adicionar Produto
        </button>
      </div>
    </form>
